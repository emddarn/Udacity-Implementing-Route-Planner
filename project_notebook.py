...
def create_gScore(self):
    ...
    self.gScore = []  #Creating an empty list to store gScore
    gScore[start] = 0  #Initializing the start node with a gScore of 0
    return self.gScore
...
def create_fScore(self):
    ...
    self.fScore = []  #Creating an empty list to store fScore
    fScore[start] = heuristic_cost_estimate(start, goal) #Initializing the fScore at Start as completely heuristic
    return self.fScore
...
def get_gScore(self, node):
    ...
    self.get_gScore = create_gScore(self,node)
